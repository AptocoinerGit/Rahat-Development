--Exec usp_IncrementalLoad_WTBASubRegion87017
--select * from [DataWH].[dbo].[WTBASubRegion87017]
--Truncate table [DataWH].[dbo].[WTBASubRegion87017]

CREATE   PROCEDURE usp_IncrementalLoad_WTBASubRegion87017
AS
BEGIN

    -- Step 1: Insert new records
    INSERT INTO [DataWH].[dbo].[WTBASubRegion87017] (
        [Description-10],
        [Code-1],
        [timestamp-0],
        [systemId-2000000000],
    ...
    SELECT
        ...
        CURRENT_TIMESTAMP
    FROM [Rahat_LH].[dbo].[WTBASubRegion87017] s
    LEFT JOIN [DataWH].[dbo].[WTBASubRegion87017] t
    ...
    FROM [DataWH].[dbo].[WTBASubRegion87017] t
    INNER JOIN [Rahat_LH].[dbo].[WTBASubRegion87017] s
    ...
    DELETE FROM [DataWH].[dbo].[WTBASubRegion87017]
    WHERE [systemId-2000000000] NOT IN (
        SELECT [systemId-2000000000]
        FROM [Rahat_LH].[dbo].[WTBASubRegion87017]
