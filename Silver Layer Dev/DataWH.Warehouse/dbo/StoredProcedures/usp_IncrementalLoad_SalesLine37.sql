-- Execute the incremental load procedure for SalesLine37
-- EXEC usp_IncrementalLoad_SalesLine37;

-- View the current data in the target table
-- SELECT * FROM [DataWH].[dbo].[SalesLine37];

-- Truncate the target table if needed (use with caution)
-- TRUNCATE TABLE [DataWH].[dbo].[SalesLine37];

-- Create or alter the incremental load procedure for SalesLine37
CREATE   PROCEDURE usp_IncrementalLoad_SalesLine37
AS
BEGIN
    -- Step 1: Insert new records
    INSERT INTO [DataWH].[dbo].[SalesLine37] (
        [BinCode-5403],
    ...
    LEFT JOIN [DataWH].[dbo].[SalesLine37] t
    ...
    SET
        ...
        t.[$Company] = s.[$Company],
        t.[UpdateDate] = CURRENT_TIMESTAMP -- UpdateDate
    FROM [DataWH].[dbo].[SalesLine37] t
    JOIN [Rahat_LH].[dbo].[SalesLine37] s
        ON t.[systemId-2000000000] = s.[systemId-2000000000]
    WHERE
        LTRIM(RTRIM(ISNULL(t.[BinCode-5403], ''))) <> LTRIM(RTRIM(ISNULL(s.[BinCode-5403], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTBASampleReasonCode-87700], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBASampleReasonCode-87700], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTBAOrderChargeCode-87600], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBAOrderChargeCode-87600], ''))) OR
        ISNULL(t.[RequestedDeliveryDate-5790], '1900-01-01') <> ISNULL(TRY_CONVERT(date, NULLIF(s.[RequestedDeliveryDate-5790], '')), '1900-01-01') OR
        LTRIM(RTRIM(ISNULL(t.[WTPCSalesPriceGroupCode-89200], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTPCSalesPriceGroupCode-89200], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTPCSalesPriceCategoryCode-89203], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTPCSalesPriceCategoryCode-89203], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[CustomerDiscGroup-7002], ''))) <> LTRIM(RTRIM(ISNULL(s.[CustomerDiscGroup-7002], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTUSBeverageTaxAreaCode-88400], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTUSBeverageTaxAreaCode-88400], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WCSAL04SampleDiscGroupCode-50120], ''))) <> LTRIM(RTRIM(ISNULL(s.[WCSAL04SampleDiscGroupCode-50120], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[PostingGroup-8], ''))) <> LTRIM(RTRIM(ISNULL(s.[PostingGroup-8], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[UnitofMeasure-13], ''))) <> LTRIM(RTRIM(ISNULL(s.[UnitofMeasure-13], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[GenProdPostingGroup-75], ''))) <> LTRIM(RTRIM(ISNULL(s.[GenProdPostingGroup-75], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[UnitofMeasureCode-5407], ''))) <> LTRIM(RTRIM(ISNULL(s.[UnitofMeasureCode-5407], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTBAAlcoholTypeCode-87050], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBAAlcoholTypeCode-87050], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTBABrandNo-87150], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBABrandNo-87150], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTIAAllocationInheritCode-90110], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTIAAllocationInheritCode-90110], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[ItemCategoryCode-5709], ''))) <> LTRIM(RTRIM(ISNULL(s.[ItemCategoryCode-5709], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[WTBABottleSize-87020], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBABottleSize-87020], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[SelltoCustomerNo-2], ''))) <> LTRIM(RTRIM(ISNULL(s.[SelltoCustomerNo-2], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[No-6], ''))) <> LTRIM(RTRIM(ISNULL(s.[No-6], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[LocationCode-7], ''))) <> LTRIM(RTRIM(ISNULL(s.[LocationCode-7], ''))) OR
        ISNULL(t.[ShipmentDate-10], '1900-01-01') <> ISNULL(TRY_CONVERT(date, NULLIF(s.[ShipmentDate-10], '')), '1900-01-01') OR
        LTRIM(RTRIM(ISNULL(t.[CustomerPriceGroup-42], ''))) <> LTRIM(RTRIM(ISNULL(s.[CustomerPriceGroup-42], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[BilltoCustomerNo-68], ''))) <> LTRIM(RTRIM(ISNULL(s.[BilltoCustomerNo-68], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[GenBusPostingGroup-74], ''))) <> LTRIM(RTRIM(ISNULL(s.[GenBusPostingGroup-74], ''))) OR
        ISNULL(t.[PlannedDeliveryDate-5794], '1900-01-01') <> ISNULL(TRY_CONVERT(date, NULLIF(s.[PlannedDeliveryDate-5794], '')), '1900-01-01') OR
        ISNULL(t.[PlannedShipmentDate-5795], '1900-01-01') <> ISNULL(TRY_CONVERT(date, NULLIF(s.[PlannedShipmentDate-5795], '')), '1900-01-01') OR
        LTRIM(RTRIM(ISNULL(t.[WCTEWSalespersonCode-50000], ''))) <> LTRIM(RTRIM(ISNULL(s.[WCTEWSalespersonCode-50000], ''))) OR
        ISNULL(t.[WTBADocumentDate-87100], '1900-01-01') <> ISNULL(TRY_CONVERT(date, NULLIF(s.[WTBADocumentDate-87100], '')), '1900-01-01') OR
        ISNULL(t.[WTBAOrderDate-87110], '1900-01-01') <> ISNULL(TRY_CONVERT(date, NULLIF(s.[WTBAOrderDate-87110], '')), '1900-01-01') OR
        LTRIM(RTRIM(ISNULL(t.[WTBABudgetSalespersonCode-87702], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBABudgetSalespersonCode-87702], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[ShortcutDimension1Code-40], ''))) <> LTRIM(RTRIM(ISNULL(s.[ShortcutDimension1Code-40], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[ShippingAgentCode-5796], ''))) <> LTRIM(RTRIM(ISNULL(s.[ShippingAgentCode-5796], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[Description-11], ''))) <> LTRIM(RTRIM(ISNULL(s.[Description-11], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[DocumentType-1], ''))) <> LTRIM(RTRIM(ISNULL(s.[DocumentType-1], ''))) OR
        LTRIM(RTRIM(ISNULL(t.[DocumentNo-3], ''))) <> LTRIM(RTRIM(ISNULL(s.[DocumentNo-3], ''))) OR
        ROUND(ISNULL(t.[LineNo-4], -1),1) <> ROUND(ISNULL(s.[LineNo-4], -1),1) OR
        LTRIM(RTRIM(ISNULL(t.[Type-5], ''))) <> LTRIM(RTRIM(ISNULL(s.[Type-5], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[VATCalculationType-77], ''))) <> LTRIM(RTRIM(ISNULL(s.[VATCalculationType-77], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[Reserve-96], ''))) <> LTRIM(RTRIM(ISNULL(s.[Reserve-96], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[PrepmtVATCalcType-116], ''))) <> LTRIM(RTRIM(ISNULL(s.[PrepmtVATCalcType-116], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[LineDiscountCalculation-180], ''))) <> LTRIM(RTRIM(ISNULL(s.[LineDiscountCalculation-180], ''))) OR
        ROUND(ISNULL(t.[DimensionSetID-480], -1),1) <> ROUND(ISNULL(s.[DimensionSetID-480], -1),1) OR
        ...
        ROUND(ISNULL(t.[SpecialOrderPurchLineNo-5715], -1),1) <> ROUND(ISNULL(s.[SpecialOrderPurchLineNo-5715], -1),1) OR
        ...
        ROUND(ISNULL(t.[RetQtyRcdNotInvdBase-5806], -1), 1) <> ROUND(ISNULL(s.[RetQtyRcdNotInvdBase-5806], -1), 1) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[PriceCalculationMethod-7000], ''))) <> LTRIM(RTRIM(ISNULL(s.[PriceCalculationMethod-7000], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[WTBAStatus-87703], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBAStatus-87703], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[WTBASOReviewStatus-87851], ''))) <> LTRIM(RTRIM(ISNULL(s.[WTBASOReviewStatus-87851], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[ERCGenSelectionOption-71276915], ''))) <> LTRIM(RTRIM(ISNULL(s.[ERCGenSelectionOption-71276915], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[SystemCreatedBy-2000000002], ''))) <> LTRIM(RTRIM(ISNULL(s.[SystemCreatedBy-2000000002], ''))) OR
        ...
        LTRIM(RTRIM(ISNULL(t.[$Company], ''))) <> LTRIM(RTRIM(ISNULL(s.[$Company], '')));

    -- Step 3: Delete records that no longer exist in the source
    DELETE FROM [DataWH].[dbo].[SalesLine37]
