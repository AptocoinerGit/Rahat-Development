--Exec usp_IncrementalLoad_WTBAVintage87008
--select * from [DataWH].[dbo].[WTBAVintage87008]
--Truncate table [DataWH].[dbo].[WTBAVintage87008]

CREATE   PROCEDURE usp_IncrementalLoad_WTBAVintage87008
AS
BEGIN

    -- Step 1: Insert new records
    INSERT INTO [DataWH].[dbo].[WTBAVintage87008] (
        [Description-10],
        [Code-1],
        [timestamp-0],
        [systemId-2000000000],
    ...
    SELECT
        ...
        CURRENT_TIMESTAMP
    FROM [Rahat_LH].[dbo].[WTBAVintage87008] s
    LEFT JOIN [DataWH].[dbo].[WTBAVintage87008] t
    ...
    FROM [DataWH].[dbo].[WTBAVintage87008] t
    JOIN [Rahat_LH].[dbo].[WTBAVintage87008] s
    ...
    DELETE FROM [DataWH].[dbo].[WTBAVintage87008]
    WHERE [systemId-2000000000] NOT IN (
        SELECT [systemId-2000000000]
        FROM [Rahat_LH].[dbo].[WTBAVintage87008]
