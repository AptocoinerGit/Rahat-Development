--Exec usp_IncrementalLoad_TeamSalesperson5084
--select * from [DataWH].[dbo].[TeamSalesperson5084]
--Truncate table [DataWH].[dbo].[TeamSalesperson5084]

CREATE   PROCEDURE usp_IncrementalLoad_TeamSalesperson5084
AS
BEGIN

    -- Step 1: Insert new records
    INSERT INTO [DataWH].[dbo].[TeamSalesperson5084] (
        [TeamCode-1],
        [SalespersonCode-2],
        [timestamp-0],
        [systemId-2000000000],
    ...
    SELECT
        ...
        CURRENT_TIMESTAMP
    FROM [Rahat_LH].[dbo].[TeamSalesperson5084] s
    LEFT JOIN [DataWH].[dbo].[TeamSalesperson5084] t
    ...
    FROM [DataWH].[dbo].[TeamSalesperson5084] t
    INNER JOIN [Rahat_LH].[dbo].[TeamSalesperson5084] s
    ...
    DELETE FROM [DataWH].[dbo].[TeamSalesperson5084]
    WHERE [systemId-2000000000] NOT IN (
        SELECT [systemId-2000000000]
        FROM [Rahat_LH].[dbo].[TeamSalesperson5084]
