--Exec usp_IncrementalLoad_WTBAWineColor87016
--select * from [DataWH].[dbo].[WTBAWineColor87016]
--Truncate table [DataWH].[dbo].[WTBAWineColor87016]

CREATE   PROCEDURE usp_IncrementalLoad_WTBAWineColor87016
AS
BEGIN

    -- Step 1: Insert new records
    INSERT INTO [DataWH].[dbo].[WTBAWineColor87016] (
        [Description-10],
        [Code-1],
        [timestamp-0],
        [systemId-2000000000],
    ...
    SELECT
        ...
        CURRENT_TIMESTAMP
    FROM [Rahat_LH].[dbo].[WTBAWineColor87016] s
    LEFT JOIN [DataWH].[dbo].[WTBAWineColor87016] t
    ...
    FROM [DataWH].[dbo].[WTBAWineColor87016] t
    INNER JOIN [Rahat_LH].[dbo].[WTBAWineColor87016] s
    ...
    DELETE FROM [DataWH].[dbo].[WTBAWineColor87016]
    WHERE [systemId-2000000000] NOT IN (
        SELECT [systemId-2000000000]
        FROM [Rahat_LH].[dbo].[WTBAWineColor87016]
